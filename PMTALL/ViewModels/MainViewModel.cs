...
public partial class MainViewModel : ObservableObject
{
    ...
    private void LoadSettings()
    {
        ...
        // Viewer settings
        if (s.ViewerSourceFolder != null) Viewer.SourceFolder = s.ViewerSourceFolder;
        Viewer.SelectedPresetIndex = s.ViewerPresetIndex;
    }
    ...
    public void SaveSettings()
    {
        var s = new AppSettings
        {
            ...
            // Viewer
            ViewerSourceFolder = Viewer.SourceFolder,
            ViewerPresetIndex = Viewer.SelectedPresetIndex
        };
    ...
    public void SetSourceFolderFromDrop(string path)
    {
        ...
        {
            Viewer.SetSourceFolderFromDrop(path);
        }
        else
        {
            SourceFolder = path;
